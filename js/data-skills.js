let SKILL_WEAPON = [
  ...
  { "name": "Alondite", "spCost": 400, "damage": 16, "range": 1, "exclusive": ["Black Knight", "Zelgius"], "weaponType": "Sword", "colorType": "Red", "effect": "Enables counterattack regardless of distance if this unit is attacked." },
  ...
  { "name": "Ellight", "spCost": 100, "damage": 6, "range": 2, "weaponType": "Tome", "colorType": "Blue", "effect": "" },
  ...
  { "name": "Gleipnir", "spCost": 400, "damage": 14, "range": 2, "weaponType": "Tome", "colorType": "Red", "exclusive": ["Eirika (Sacred Memories)"], "effect": "Grants Res+3. If foe's HP = 100% at start of combat, grants Atk/Spd+3 during combat." },
  ...
  { "name": "Great Flame", "spCost": 400, "damage": 16, "range": 1, "weaponType": "Breath", "exclusive": ["Myrrh"], "effect": "Grants Atk+3. If unit's Def - foe's Def ≥ 5, foe can't make a follow-up attack. If foe's Range = 2, damage calculated using the lower of foe's Def or Res." },
  ...
  { "name": "Ivaldi", "spCost": 400, "damage": 14, "range": 2, "weaponType": "Tome", "colorType": "Blue", "exclusive": ["L'Arachel"], "effect": "Grants Def+3. If foe's HP = 100% at start of combat, grants Atk/Spd+3 during combat." },
  ...
  { "name": "Light", "spCost": 50, "damage": 4, "range": 2, "weaponType": "Tome", "colorType": "Blue", "effect": "" },
  ...
  { "name": "Naglfar", "spCost": 400, "damage": 14, "range": 2, "exclusive": ["Lyon"], "weaponType": "Tome", "colorType": "Red", "effect": "Grants weapon advantage vs. colorless foes.", },
  ...
  { "name": "Ragnell", "spCost": 400, "damage": 16, "range": 1, "exclusive": ["Ike", "Ike (Legendary Heroes)"], "weaponType": "Sword", "colorType": "Red", "effect": "Enables counterattack regardless of distance if this unit is attacked.", },
  ...
  { "name": "Shine", "spCost": 200, "damage": 9, "range": 2, "weaponType": "Tome", "colorType": "Blue", "effect": "" },
  { "name": "Shine+", "spCost": 300, "damage": 13, "range": 2, "weaponType": "Tome", "colorType": "Blue", "effect": "" },
  ...
  { "name": "Thani", "spCost": 400, "damage": 14, "range": 2, "exclusive": ["Micaiah"], "weaponType": "Tome", "colorType": "Blue", "effect": "Grants Res+3. Effective against armored and cavalry foes. Against armored and cavalry foes using bow, dagger, magic, or staff, damage from first attack received by unit during combat reduced by 30%." },
...
let SKILL_ASSIST = [
  ...
  { "name": "Sacrifice", "range": 1, "spCost": 400, "include": [{"name": "Micaiah"}], "effect": "Converts penalties on target into bonuses. Restores target's HP = unit's current HP -1. Unit's HP reduced by amount restored." },
...
let SKILL_SPECIAL = [
  ...
  { "name": "Black Luna", "cooldown": 3, "spCost": 500, "include": [{ "name": "Black Knight" },{ "name": "Zelgius" }], "effect": "Resolve combat as if foe suffered Def/Res-80%. (Skill cannot be inherited.)" },
  ...
  { "name": "Radiant Aether", "cooldown": 4, "spCost": 500, "include": [{ "name": "Ike (Legendary Heroes)" }], "effect": "During combat, treats foe's Def/Res as if reduced by 50%. Restores HP = 50% of damage dealt." },
...
let SKILL_A = [
  ...
  { "name": "Warding Breath", "spCost": 240, "icon": "36-2", "include": [{"weaponType":"Sword"}, {"weaponType":"Axe"}, {"weaponType":"Lance"}, {"weaponType":"Breath"}], "exclude": [{"moveType":"Flying"}, {"moveType":"Cavalry"}], "effect": "Grants Res+4 during combat if unit is attacked. Also grants Special cooldown charge +1 per attack. (Does not stack. Only highest value applied.)" },
...
let SKILL_B = [
  ...
  { "name": "Warp Powder", "spCost": 300, "icon": "35-5", "include": [{"name":"Zelgius"}], "effect": "If unit's HP ≥ 80%, unit can move adjacent to any ally within 2 spaces. (Skill cannot be inherited.)" },
...
let SKILL_C = [
  ...
  { "name": "Hone Dragons", "spCost": 200, "icon": "35-8", "include": [{"weaponType": "Breath"}], "effect": "Grants adjacent dragon allies Atk/Spd+6 through their next actions at the start of each turn." },
  ...
  { "name": "R Tome Exp. 1", "spCost": 30, "icon": "35-12", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If using red magic and unit survives combat, unit gets 1.5x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  { "name": "R Tome Exp. 2", "spCost": 60, "icon": "36-0", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If unit survives combat, all red magic users on team get 1.5x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  { "name": "R Tome Exp. 3", "spCost": 120, "icon": "36-1", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If unit survives combat, all red magic users on team get 2x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  ...
  { "name": "Res Tactic 1", "spCost": 60, "icon": "35-9", "effect": "At start of turn, grants Res+2 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
  { "name": "Res Tactic 2", "spCost": 120, "icon": "35-10", "effect": "At start of turn, grants Res+4 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
  { "name": "Res Tactic 3", "spCost": 240, "icon": "35-11", "effect": "At start of turn, grants Res+6 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
  ...
  { "name": "Spur Atk/Spd 2", "spCost": 120, "icon": "35-6", "effect": "Grants adjacent allies Atk/Spd +2 during combat." },
  { "name": "Spur Atk/Spd 3", "spCost": 240, "icon": "35-7", "effect": "Grants adjacent allies Atk/Spd +3 during combat." },
...
let SKILL_SEAL = [
  ...
  { "name": "Def Ploy 1", "icon" : "20-2", "effect": "At start of turn, all foes in cardinal directions with Res 1 or more lower than unit suffer Def-3 until the end of foe's next action." },
  { "name": "Def Ploy 2", "icon" : "20-3", "effect": "At start of turn, all foes in cardinal directions with Res 1 or more lower than unit suffer Def-4 until the end of foe's next action." },
  { "name": "Def Ploy 3", "icon" : "20-4", "effect": "At start of turn, all foes in cardinal directions with Res 1 or more lower than unit suffer Def-5 until the end of foe's next action." },
  ...
  { "name": "Deflect Melee 1", "effect": "If unit receives consecutive attacks from a foe using a sword, lance, or axe, damage from second attack onward reduced by 30%.", "include": [{"weaponType":"Sword"}, {"weaponType":"Axe"}, {"weaponType":"Lance"}, {"weaponType":"Breath"}], "icon": "28-11" },
  { "name": "Deflect Melee 2", "effect": "If unit receives consecutive attacks from a foe using a sword, lance, or axe, damage from second attack onward reduced by 50%.", "include": [{"weaponType":"Sword"}, {"weaponType":"Axe"}, {"weaponType":"Lance"}, {"weaponType":"Breath"}], "icon": "28-12" },
  { "name": "Deflect Melee 3", "effect": "If unit receives consecutive attacks from a foe using a sword, lance, or axe, damage from second attack onward reduced by 80%.", "include": [{"weaponType":"Sword"}, {"weaponType":"Axe"}, {"weaponType":"Lance"}, {"weaponType":"Breath"}], "icon": "29-0" },
  ...
  { "name": "Drive Def 1", "icon": "18-10", "effect": "Grants allies within 2 spaces Def+2 during combat." },
  { "name": "Drive Def 2", "icon": "18-11", "effect": "Grants allies within 2 spaces Def+3 during combat." },
  ...
  { "name": "Hone Atk 1", "icon": "12-0", "effect": "Grants adjacent allies Atk+2 through their next actions at the start of each turn." },
  { "name": "Hone Atk 2", "icon": "12-1", "effect": "Grants adjacent allies Atk+3 through their next actions at the start of each turn." },
  { "name": "Hone Atk 3", "icon": "12-2", "effect": "Grants adjacent allies Atk+4 through their next actions at the start of each turn." },
  ...
  { "name": "Poison Strike 1", "icon": "6-9", "exclude": [{"weaponType": "Staff"}], "effect": "Inflicts 4 damage to foe after any combat this unit initiates." },
  { "name": "Poison Strike 2", "icon": "6-10", "exclude": [{"weaponType": "Staff"}], "effect": "Inflicts 7 damage to foe after any combat this unit initiates." },
  { "name": "Poison Strike 3", "icon": "6-11", "exclude": [{"weaponType": "Staff"}], "effect": "Inflicts 10 damage to foe after any combat this unit initiates." },
  { "name": "Quick Riposte 1", "icon": "6-3", "effect": "Unit automatically makes a follow-up attack if attacked at HP ≥ 90%." },
  { "name": "Quick Riposte 2", "icon": "6-4", "effect": "Unit automatically makes a follow-up attack if attacked at HP ≥ 80%." },
  { "name": "Quick Riposte 3", "icon": "6-5", "effect": "Unit automatically makes a follow-up attack if attacked at HP ≥ 70%." },
  ...
  { "name": "Seal Atk 1", "icon": "7-5", "exclude": [{"weaponType": "Staff"}], "effect": "After combat, foe suffers Atk-3 through its next action." },
  { "name": "Seal Atk 2", "icon": "7-6", "exclude": [{"weaponType": "Staff"}], "effect": "After combat, foe suffers Atk-5 through its next action." },
  { "name": "Seal Atk 3", "icon": "7-7", "exclude": [{"weaponType": "Staff"}], "effect": "After combat, foe suffers Atk-7 through its next action." },
  ...
  { "name": "Squad Ace F 1", "effect": "Grants HP+3.", "stats": {"hp": 3}, "icon": "21-1" },
  { "name": "Squad Ace F 2", "effect": "Grants HP+4.", "stats": {"hp": 4}, "icon": "21-2" },
  { "name": "Squad Ace F 3", "effect": "Grants HP+5.", "stats": {"hp": 5}, "icon": "21-3" },
  { "name": "Threaten Spd 1", "icon": "13-8", "effect": "Inflicts Spd-3 on foes within 2 spaces through their next actions at the start of each turn." },
  { "name": "Threaten Spd 2", "icon": "13-9", "effect": "Inflicts Spd-4 on foes within 2 spaces through their next actions at the start of each turn." },
  { "name": "Threaten Spd 3", "icon": "13-10", "effect": "Inflicts Spd-5 on foes within 2 spaces through their next actions at the start of each turn." }
];
...
let SKILL_REFINED_WEAPONS = {
  ...
  "Parthia": [
    {"name": "+Atk vs Ranged", "icon": "35-3", "cost": 1, "effect": "Effective against flying foes. If foe uses magic, damage from first attack received by unit during combat reduced by 30%. Grants Atk+6 during combat if foe uses bow, dagger, magic, or staff."},
    {"name": "+Atk", "icon": "31-9", "cost": 1, "effect": "Effective against flying foes. If foe uses magic, damage from first attack received by unit during combat reduced by 30%.", "stats": {"hp": 2, "atk": 1}},
    {"name": "+Spd", "icon": "31-10", "cost": 1, "effect": "Effective against flying foes. If foe uses magic, damage from first attack received by unit during combat reduced by 30%.", "stats": {"hp": 2, "spd": 2}},
    {"name": "+Def", "icon": "31-11", "cost": 1, "effect": "Effective against flying foes. If foe uses magic, damage from first attack received by unit during combat reduced by 30%.", "stats": {"hp": 2, "def": 3}},
    {"name": "+Res", "icon": "31-12", "cost": 1, "effect": "Effective against flying foes. If foe uses magic, damage from first attack received by unit during combat reduced by 30%.", "stats": {"hp": 2, "res": 3}}
  ],
  "Cymbeline": [
    {"name": "Atk/Res Bond", "icon": "35-4", "cost": 1, "effect": "Grants allies within 2 spaces Atk+3 during combat. Grants Atk/Res+5 during combat if within 2 spaces of a flying ally."},
    {"name": "+Atk", "icon": "31-9", "cost": 1, "effect": "", "stats": {"hp": 2, "atk": 1}},
    {"name": "+Spd", "icon": "31-10", "cost": 1, "effect": "", "stats": {"hp": 2, "spd": 2}},
    {"name": "+Def", "icon": "31-11", "cost": 1, "effect": "", "stats": {"hp": 2, "def": 3}},
    {"name": "+Res", "icon": "31-12", "cost": 1, "effect": "", "stats": {"hp": 2, "res": 3}}
  ]
};
