...
let SKILL_C = [
  ...
  { "name": "Hone Dragons", "spCost": 200, "icon": "0-0", "include": [{"weaponType": "Breath"}], "effect": "Grants adjacent dragon allies Atk/Spd+6 through their next actions at the start of each turn." },
  ...
  { "name": "R Tome Exp. 1", "spCost": 30, "icon": "0-0", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If using red magic and unit survives combat, unit gets 1.5x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  { "name": "R Tome Exp. 2", "spCost": 60, "icon": "0-0", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If unit survives combat, all red magic users on team get 1.5x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  { "name": "R Tome Exp. 3", "spCost": 120, "icon": "0-0", "include": [{"weaponType": "Tome", "colorType": "Red"}], "effect": "If unit survives combat, all red magic users on team get 2x EXP. (If similar skill effects also used, only highest multiplier applied.)" },
  ...
  { "name": "Res Tactic 1", "spCost": 60, "icon": "0-0", "effect": "At start of turn, grants Res+2 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
  { "name": "Res Tactic 2", "spCost": 120, "icon": "0-0", "effect": "At start of turn, grants Res+4 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
  { "name": "Res Tactic 3", "spCost": 240, "icon": "0-0", "effect": "At start of turn, grants Res+6 to allies within 2 spaces for 1 turn. Granted only if number of that ally's movement type on current team ≤ 2." },
