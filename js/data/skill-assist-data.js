module.exports = [
  ...
  },
  {
    ...
    range: 1,
    spCost: 150,
    include: [{name: "Olivia"},{name: "Ninian"},{name: "Olivia (Performing Arts)"},{name: "Inigo (Performing Arts)"},{name: "Lene"},{name: "Ninian (Bridal Bloom)"},{name: "Olivia (Ylissean Travellers)"}],
    last: true,
